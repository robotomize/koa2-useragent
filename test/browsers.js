...
exports['iPad 2'] = function(test) {
  const source = 'Mozilla/5.0 (iPad; CPU OS 5_0 like Mac OS X) AppleWebKit/534.46' + ' (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3',
      a = ua.parse(source);
...
exports['Linux Iceweasel'] = function(test) {
  const s = 'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.1.16)' + ' Gecko/20111108 Iceweasel/3.5.16 (like Firefox/3.5.16)',
      a = ua.parse(s);
...
exports['Linux Chrome 17'] = function(test) {
  const s = 'Mozilla/5.0 (X11; Linux i686) AppleWebKit/535.11 (KHTML, like Gecko)' + ' Chrome/17.0.963.56 Safari/535.11',
      a = ua.parse(s);
...
exports['Linux Chromium 39'] = function(test) {
  const s = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko)' + ' Ubuntu Chromium/39.0.2171.65 Chrome/39.0.2171.65 Safari/537.36',
      a = ua.parse(s);
...
exports['Linux Ephiphany 2.30'] = function(test) {
  const s = 'Mozilla/5.0 (X11; U; Linux i686; en-us) AppleWebKit/531.2+ (KHTML, like Gecko)' + ' Version/5.0 Safari/531.2+ Debian/squeeze (2.30.6-1) Epiphany/2.30.6',
      a = ua.parse(s);
...
exports['Windows XP Safari'] = function(test) {
    const s = 'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/534.51.22 (KHTML, like Gecko)' + ' Version/5.1.1 Safari/534.51.22',
        a = ua.parse(s);
...
exports['Windows XP Chrome'] = function(test) {
  const s = 'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/535.19' + ' (KHTML, like Gecko) Chrome/18.0.1025.162 Safari/535.19',
      a = ua.parse(s);
...
exports['OS X OmniWeb 622'] = function(test) {
  const s = 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X; en-US) AppleWebKit/528.16' + '(KHTML, like Gecko, Safari/528.16) OmniWeb/v622.8.0.112941',
      a = ua.parse(s);
...
exports['OS X Safari 530'] = function(test) {
  const s = 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_8; en-us)' + ' AppleWebKit/530.19.2 (KHTML, like Gecko) Version/4.0.2 Safari/530.19',
      a = ua.parse(s);
...
exports['Android Samsung'] = function(test) {
  const s = 'Mozilla/5.0 (Linux; U; Android 2.2; en-ca; SGH-T959D Build/FROYO) AppleWebKit/533.1' + ' (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1',
      a = ua.parse(s);
...
exports['America Online Browser'] = function(test) {
  const s = 'Mozilla/4.0 (compatible; MSIE 7.0;' + ' America Online Browser 1.1; Windows NT 5.1; (R1 1.5); .NET CLR 2.0.50727; InfoPath.1)',
      a = ua.parse(s);
